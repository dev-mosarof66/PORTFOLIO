          ...
          <div className="w-full sm:w-[90%] lg:w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            ...
            >
              ...
              <p className="text-gray-300 max-w-lg leading-relaxed">
                Innovative full-stack developer skilled in JavaScript,
                TypeScript, React, Next.js, MongoDB, and Node.js. Dedicated to
                crafting efficient solutions and optimizing for performance and
                optimization.
              </p>
              ...
              <BackgroundGradient>
                <div className="w-full bg-gray-800 rounded-lg overflow-hidden">
                  ...
                  <div className="p-4 font-mono text-sm text-gray-200">
                    <p>$ name</p>
                    <span className="text-purple-400 px-2">
                      Mosarof Hossain
                    </span>
